...
// console.log(keccak256(privateKey))
// console.log(keccak256(ethereumUtil.privateToPublic(privateKey)))

console.log("0x" + privateKey.toString('hex'))
console.log(ethereumUtil.bufferToHex(ethereumUtil.privateToPublic(privateKey)))
